...
import 'package:graduation_project/screens/chats/chat_item.dart';
...
import 'package:graduation_project/screens/select_type_labs/select_typeOf_labs.dart';
...
class AppointmentTest extends StatefulWidget {
  late LabModel lab;

  AppointmentTest(this.lab, {super.key});

  @override
  State<AppointmentTest> createState() => _AppointmentState();
}

class _AppointmentState extends State<AppointmentTest> {
  String gender = "ذكر";
...
//AppointmentTest
//appbar( رجوع) => (دي شاشة حجز ميعاد بس لمعمل تحاليل )
