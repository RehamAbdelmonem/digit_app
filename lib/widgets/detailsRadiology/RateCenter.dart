...
class RateCenter extends StatefulWidget {
  late String labId;

  RateCenter(this.labId);

  @override
  _RateCenterState createState() => _RateCenterState();
}

class _RateCenterState extends State<RateCenter> {
  int _rating=0;
